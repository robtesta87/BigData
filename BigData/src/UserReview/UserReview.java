...
public class UserReview {
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
	    ...
	    Job job1 = Job.getInstance(conf, "UserReview");
	    job1.setJarByClass(UserReview.class);
	    
	    job1.setMapperClass(UserReviewMapper.class);
	    //job.setCombinerClass(NumberPieciesSoldcer.class);
	    job1.setReducerClass(UserReviewReducer.class);
